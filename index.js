...
const vcard = 'BEGIN:VCARD\n'
            ...
            + 'FN:Guilherme\n' // Nama kamu
            + 'ORG:PepyBot;\n' // Nama bot
            + 'TEL;type=CELL;type=VOICE;waid=5519999897566:+55 19999897566\n' //Nomor whatsapp kamu
            + 'END:VCARD'
prefix = '/','*','.'
blocked = []
limitawal = '999999999'
		...
		try {
			...
			mess = {
				...
				only: {
					...
					userB: `──「 LISTA 」──\nOlá Kak !\nDesculpe, irmãi. Você não está registrado como amigo de pepy. Registre-se para fazer amizade com o bot Pepy por meio, \n\nCommand : ${prefix}daftar nome|idade\nExemplo : ${prefix}daftar pepy|14\n\n──「 Pepy BOT 」──`,
			...
			const premium = ["551999897566@s.whatsapp.net","559784130980@s.whatsapp.net","557599941062@s.whatsapp.net","5519999897566@s.whatsapp.net","5511949051934@s.whatsapp.net","554792091566@s.whatsapp.net","558699541889@s.whatsapp.net","559294313229@s.whatsapp.net","554298653614@s.whatsapp.net"]
...
if (messagesC.includes("vadia")){
			client.updatePresence(from, Presence.composing)
			reply("Sua mãe kkkkkk")
	}
	
if (messagesC.includes("Gui")){
			client.updatePresence(from, Presence.composing)
			reply("Meu criador?️")
	}
	
if (messagesC.includes("picolino")){
			client.updatePresence(from, Presence.composing)
			reply("Ta falando do meu criador? eu amo ele ❤️")
	}
...
// recursos anime, random @nabuto domina vida
          ...
          reply('Espere..')
			    ...
			    case 'owner':
			    case 'dono':
                    client.sendMessage(from, {displayname: "Gui Developer", vcard: vcard}, MessageType.contact, { quoted: mek})
                    client.sendMessage(from, 'Meu dono é esse gasoso aí tal de "Guilherme"🙄, chama ele aí.\nEle diz que é "Shitpost"\nhttps://wa.me/+5519999897566',MessageType.text, { quoted: mek} )
                    break
                case 'fitnah':	
				case 'fake':          
                    if (!isGroup) return reply(mess.only.group)
